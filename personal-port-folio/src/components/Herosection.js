...
const HeroSection = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-12">
      ...
      <h1 className="mx-auto max-w-4xl font-display text-1xl font-medium tracking-tight text-slate-900 sm:text-4xl">
        <span className="inline-block">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative pl-2">Web developer </span>
          </span>
        </span>
        <span className="inline-block pl-2"> based in Lahore</span>
      </h1>
